              ...
              <Card className="shadow-2xl border-l-4 border-l-primary bg-card hover:shadow-3xl transition-all duration-300 border-0">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      Working on modern web projects using the full MERN stack,
                      developing robust and scalable applications that serve
                      thousands of users across various industries.
                    </motion.p>
